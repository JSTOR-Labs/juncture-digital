...
In this example, the sequence attribute is used to specify a particular image to be used from a manifest with multiple images. In this case, page 291 is shown.
